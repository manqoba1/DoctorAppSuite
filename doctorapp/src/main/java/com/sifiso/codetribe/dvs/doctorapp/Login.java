...
import com.sifiso.codetribe.dvs.doctorlib.dto.GcmdeviceDTO;
...
import com.sifiso.codetribe.dvs.doctorlib.util.GCMUtil;
...
public class Login extends Activity {
    ...
    private void build() {
        ...
        L_login.setOnClickListener(login);
            ...
            WebSocketUtil.sendRequest(ctx, Statics.DVS_ENDPOINT, r, new WebSocketUtil.WebSocketListener() {
                ...
                public void onMessage(ResponseDTO r) {
                    if (r.getStatusCode() == 0) {
                        ...
                        SharedUtil.setDoctor(ctx, r.getDoctor());
                        ed.commit();
